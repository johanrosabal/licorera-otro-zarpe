...
export function PurchaseForm({ initialPurchaseData, onFinished }) {
  ...
  useEffect(() => {
    if (isEditing && initialPurchaseData) {
        const purchaseDate = initialPurchaseData.invoiceDate?.toDate ? initialPurchaseData.invoiceDate.toDate() : new Date();
        form.reset({
            ...initialPurchaseData,
    ...
    <AuthorizedOnly allowedRoles={['ADMIN']}>
      <Form {...form}>
        ...
        <div className="space-y-6">
          ...
          <div>
            <h3 className="text-lg font-medium mb-2">Productos en la Factura</h3>
             {/* Desktop Table View */}
          ...
          <DialogFooter className="flex-col items-end gap-4 sm:flex-row">
            ...
            <div className="flex gap-2">
                <Button type="button" variant="outline" size="lg" onClick={onFinished} disabled={submitting}>
                    Cancelar
                </Button>
